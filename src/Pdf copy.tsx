...
function Pdf() {
  ...
  // pdf.getPageLayout();
  // pdf.getPageLayout().then((layout) => console.log(layout));
  // pdf.getViewerPreferences().then(d => console.log(d));
  // pdf.saveDocument();
  // console.log(pdf.getPageLayout());
  // });
    ...
    <div tabIndex={1}>
      <div id="outerContainer">
        ...
        <div id="mainContainer">
          ...
          <div id="viewerContainer" tabIndex={0} ref={myContainer}>
