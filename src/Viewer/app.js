...
import { PDFBug } from './debugger';
import { WorkerMessageHandler } from "../src/core/worker";
...
async function loadFakeWorker() {
  ...
  // if (typeof PDFJSDev === "undefined") {
  //   window.pdfjsWorker = await import("../node_modules/pdfjs-dist/build/pdf.worker.min.js");
  //   return;
  // }
